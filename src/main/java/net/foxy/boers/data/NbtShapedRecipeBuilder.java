...
public class NbtShapedRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
    ...
    public NbtShapedRecipeBuilder(RecipeCategory category, ItemStack result, int count) {
     ...
     * Creates a new builder for a shaped recipe.
     */
    public static NbtShapedRecipeBuilder shaped(RecipeCategory category, ItemStack result, int count) {
    ...
    public NbtShapedRecipeBuilder group(@Nullable String groupName) {
    ...
    public static class Result extends CraftingResult {
        ...
        public void serializeRecipeData(JsonObject json) {
            ...
            jsonobject1.addProperty("item", BuiltInRegistries.ITEM.getKey(this.result.getItem()).toString());
            if (this.count > 1) {
                jsonobject1.addProperty("count", this.count);
            }

            if (result.hasTag()) {
                jsonobject1.addProperty("nbt", result.getTag().toString());
            }
